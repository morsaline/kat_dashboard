...
import { useGetSubCategoryQuery } from "@/redux/features/skills/skillsApi";
...
export default function AllSubCategoriesTable() {
  ...
  // Handle API response and map it to a table-compatible format
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-8">
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          {subCategories.map((row: any, i: number) => (
            <tr
              key={i}
